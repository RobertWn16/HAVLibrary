...
public:   
	...
	winrt::hresult STDMETHODCALLTYPE CreateDisplay(REFIID iid, unsigned int index, IDisplay **Out);
	winrt::hresult STDMETHODCALLTYPE CreateDecoder(REFIID iid, VIDEO_SOURCE_DESC vsrc_desc, IDev* dev, IDecoder **Out);
